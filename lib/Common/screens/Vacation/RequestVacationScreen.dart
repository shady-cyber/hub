...
import 'package:hub/Data/model/vacations.dart';
                ...
                child: Column(
                  children: [
                    ...
                    return ButtonGlobal(
                      ...
                      loading: Provider.of<EmployeeProvider>(context, listen: false).loading_btn,
                      onPressed: () {
                        setState(() {
                          Provider.of<EmployeeProvider>(context, listen: false).loading_btn = true;
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(
                          ...
                          provider.sendVacationRequest(
                            ...
                            if (status.isSuccess) {
                              ...
                              Provider.of<EmployeeProvider>(context, listen: false).loading_btn = false;
                            }
                          }),
