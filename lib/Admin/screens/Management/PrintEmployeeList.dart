...
import 'package:hub/Admin/screens/Management/MarkAttendance.dart';
...
class PrintEmployeeList extends StatefulWidget {
  const PrintEmployeeList({Key? key}) : super(key: key);

  @override
  _PrintEmployeeListState createState() => _PrintEmployeeListState();
}

class _PrintEmployeeListState extends State<PrintEmployeeList> {
  ...
  void initState() {
    super.initState();
    setState(() {
        ManagementWidget().initAttendanceEmployee(context, showProgress);
    });
  }
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: employeeProvider.userCheckedCards.isEmpty
                                              ? Colors.white
                                              : kMainColor,
                                        ),
                                        child: Row(
                                          ...
                                          itemBuilder: (context, i) {
                                            ...
                                            return Padding(
                                              ...
                                              child: Container(
                                                  ...
                                                  child: GestureDetector(
                                                    onTap: () {
                                                      RequestsWidget().showSheet(context, i, employeeProvider.employeeModel[i].employeeId);
                                                    },
                                                    child: ListTile(
                                                      leading:
                                                      SizedBox(
