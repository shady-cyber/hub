...
import 'package:hub/Data/database/db/attendanceDB.dart';
import 'package:hub/Data/database/helper/common.dart';
import 'package:hub/Data/database/model/attendance_model.dart';
import 'package:hub/Data/model/employee_model.dart';
import 'package:hub/Data/model/missed_attendance.dart';
import 'package:hub/Data/repository/attendance_repo.dart';
import 'package:hub/Data/repository/auth_repo.dart';
import 'package:hub/Data/repository/response_model.dart';
import 'package:hub/Data/response/base/error_response.dart';
import 'package:hub/Employee/screens/Attendance/check_out_custom_dialog.dart';
      ...
      if(apiResponse.response != "") {
        ...
        if (apiResponse.response.statusCode == 200) {
          ...
          showDialog(context: context,
              builder: (_) =>
                  UtilsWidget().showDialogQrCardState(
          ...
          showDialog(context: context,
              builder: (_) =>
                  UtilsWidget().showDialogQrCardState("failed", responseMessage));
        }
