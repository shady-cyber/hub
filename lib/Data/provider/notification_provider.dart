...
import 'package:hub/Data/database/db/notificationDB.dart';
import 'package:hub/Data/database/model/notification_model.dart';
...
class NotificationProvider with ChangeNotifier {
  ...
  Future handleFcmSubscribtion() async {
    ...
    if (_getsubcription == true) {
      ...
      _fcm.subscribeToTopic('hub');
      _subscribed = true;
      notifyListeners();
      print('subscribed');
    } else {
      await sp.setBool('subscribe', false);
      _fcm.unsubscribeFromTopic('hub');
      _subscribed = false;
      notifyListeners();
      print('unsubscribed');
    }
