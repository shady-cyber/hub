            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    DecorationWidget().text("Day".tr(), fontFamily: 'Medium'),
                    DecorationWidget().text(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    DecorationWidget().text("Check in".tr(), textColor: kGreyTextColor),
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
...
class TopBarState extends State<TopBar> {
  @override
  Widget build(BuildContext context) {
    DecorationWidget().changeStatusColor(kMainColor);
    return SafeArea(
      child: Stack(
        children: [
                        ...
                        ? Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: DecorationWidget().text(widget.titleName,
